return require("packer").startup(function(use)
    ...
    -- Language server use {'hrsh7th/nvim-cmp', config = "require('neoc.plugins.nvim-cmp')"} -- Autocompletion plugin use {'hrsh7th/cmp-nvim-lsp', requires = 'neovim/nvim-lspconfig', config = "require('neoc.plugins.cmp-nvim-lsp')"} -- LSP source for nvim-cmp
    use({
        "williamboman/nvim-lsp-installer",
        config = "require('neoc.plugins.nvim-lsp-installer')",
    ...
    use({
        ...
        config = "require('neoc/plugins/null-ls')",
    })
